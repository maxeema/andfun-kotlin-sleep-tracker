...
fun SleepNight.describeNight() = if (sleepQuality in nightQualityNames.indices) app.getString(nightQualityNames[sleepQuality]) else  "- - -"
...
fun SleepNight.presentNight() = when (sleepQuality) {
...
fun SleepNight.logNight() = "%s - %s".format(
